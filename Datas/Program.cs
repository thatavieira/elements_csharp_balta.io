...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //
            // var horaAustralia = TimeZoneInfo.ConverTimeFromUtc(dateTime, timezoneAustralia);
            // Console.WriteLine(horaAustralia);
            //
            // var horaAtual = TimeZoneInfo.ConverTimeFromUtc(horaAustralia, timezoneAustralia);
